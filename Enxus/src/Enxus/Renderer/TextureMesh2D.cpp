...
namespace Enxus
{
    ...
    TextureMesh2D::TextureMesh2D(const TextureMesh2DData &textureData)
        : m_RendererId(0), m_TextureData(textureData)
    {
        CreateTexture();
    }

    TextureMesh2D::TextureMesh2D(const std::string &texturePath, TextureType type)
    ...
    void TextureMesh2D::CreateTexture()
    {
    ...
    void TextureMesh2D::Unbind() const
    {
